$(document).ready(function(){
    ...
    $('#demo-fileInput-4').filer({
        changeInput: '<div class="jFiler-input-dragDrop" style="width:80%;height:196px; margin-top:36px;" ><div class="jFiler-input-inner" style="margin-top:48px;"><div class="jFiler-input-icon"><i class="icon-jfi-folder"></i></div><div class="jFiler-input-text"><h3>点击上传头像</h3></div></div></div>',
        showThumbs: true,
        theme: "dragdropbox",
