$(document).ready(function(){
    ...
    $('#demo-fileInput-4').filer({
    	extensions: ['jpg', 'jpeg', 'png', 'gif'],
        changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-folder"></i></div><div class="jFiler-input-text"><h3>点击上传头像</h3></div></div></div>',
        showThumbs: true,
        theme: "dragdropbox",
