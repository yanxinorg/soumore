                        ...
                        <div class="ibox-title">
                            <div class="ibox-tools">
                               <div class="pull-right">
                                    <a type="button" class="btn btn-sm btn-white" href="{{ url('/back/link/list') }}"> <i class="fa fa-list">列表</i></a>
                               </div>
                            </div>
                        </div>
                        <div class="ibox-content">
                            <form method="post" action="{{ url('/back/link/store') }}" class="form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                 <div class="form-group" hidden>
			                          <input type="text" name="id" class="form-control" value="{{ $link->id }}">
			                     </div>
                               <div class="hr-line-dashed"></div>
			                   <div class="form-group">
			                		<label class="col-sm-2 control-label">所属分类</label>
				                	<div class="col-sm-6">
					                	<select data-placeholder="Choose a Country..." class="chosen-select form-control"  tabindex="4" name="cate_id">
							                <option value="0">顶级分类</option>
							                 @foreach($pids as $pid)
				                            	@if($pid->id == $link->cate_id )
					                ...
					                <div class="col-sm-2">
	                              		 ...
	                              		 <span class="label label-danger">{{ $errors->first('cate_id') }}</span>
								         @endif
	                              	</div>
				                </div>
                               ...
                               <div class="form-group">
                                	<label class="col-sm-2 control-label">链接地址<span class="required ">*</span></label>
                                    <div class="col-sm-6">
                                    	<input type="text" class="form-control" name="url" value="{{ $link->url }}" placeholder="http://www.soumore.cn">
                                    </div>
                                    <div class="col-sm-2">
	                              		 @if ($errors->has('url'))
                                    ...
                                    <div class="col-sm-6">
                                    	<div class="file-preview-frame krajee-default  kv-preview-thumb" id="preview-1516346124078_80-0" data-fileindex="0" data-template="image">
	                                    	<div class="kv-file-content">
												<img src="{{ $link->thumb }}" class="file-preview-image kv-preview-data rotate-1" title="cover.jpg" alt="cover.jpg" style="width:auto;height:auto;max-width:100%;max-height:100%;">
											</div>
                                ...
                                <div class="hr-line-dashed"></div>
                                 <div class="form-group">
				                	...
				                	<div class="col-sm-6">
					                	<select data-placeholder="Choose a Country..." class="chosen-select form-control"  tabindex="4" name="tag_id">
							                <option value="0">顶级标签</option>
							                 @foreach($tags as $tag)
				                            	@if($tag->id == $link->tag_id )
					                ...
					                <div class="col-sm-2">
	                              		 ...
	                              		 <span class="label label-danger">{{ $errors->first('tag_id') }}</span>
								         @endif
	                              	</div>
				                </div>
                                ...
                                <div class="form-group">
                                	<label class="col-sm-2 control-label">备注</label>
                                     <div class="col-sm-6">
                                    	<textarea class="form-control" rows="3" name="desc">{{ $link->desc }}</textarea>
                                     </div>
                                </div>
