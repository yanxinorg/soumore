	                   	...
	                   	<section class="mail-box-info">
		                    <header class="header">
		                        ...
		                        @if($uid == Auth::id())
		                        	...
		                        	<a href="{{ URL::action('Front\HomeController@answer', ['uid'=>$uid]) }}"><button class="btn btn-success btn-sm">我的回答</button></a>
		                        ...
		                        @else
		                        	...
		                        	<a href="{{ URL::action('Front\HomeController@answer', ['uid'=>$uid]) }}"><button class="btn btn-success btn-sm">他的回答</button></a>
										...
										<div class="span12" >
											<div class="media" style="margin-bottom: 12px;">
												...
												<div class="media-body">
													<div><span style="font-size: 14px;"><a target="_blank" href="{{ URL::action('Front\HomeController@index', ['uid'=>$question->user_id]) }}" href="">{{ $question->user_name }}</a></span><span style="margin-left:24px;font-size:12px;">{{\Carbon\Carbon::parse($question->created_at)->diffForHumans()}}</span></div>
