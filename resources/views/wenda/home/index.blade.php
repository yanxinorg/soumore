            ...
            <div class="row">
                   	...
                   	<section class="mail-box-info">
	                    <header class="header">
	                        <div class="compose-btn pull-left">
	                        	@if($uid == Auth::id())
	                        	   <a href="{{ URL::action('Front\HomeController@index', ['uid'=>$uid]) }}"><button class="btn btn-success btn-sm">我的动态</button></a>
	                        	...
	                        	@else
	                        	   <a href="{{ URL::action('Front\HomeController@index', ['uid'=>$uid]) }}"><button class="btn btn-success btn-sm">他的动态</button></a>
                ...
                <div class="col-md-2">
                    <div class="row">
                        <div class="col-md-12">
                           	<div class="panel">
		                        <header class="panel-heading">最近访客</header>
		                        <div class="panel-body">
		                            	@foreach($recents as $recent)
		                            	<div class="media">
				                            <a target="_blank" href="{{ URL::action('Front\HomeController@index', ['uid'=>$recent->user_id]) }}" class="pull-left">
				                                <img style="width: 48px;" src="{{ route('getThumbImg', $recent->user_id) }}" >
				                            </a>
				                            <div class="media-body">
				                                <h5 class="media-heading" style="font-size:16px;"><a target="_blank" href="{{ URL::action('Front\HomeController@index', ['uid'=>$recent->user_id]) }}">{{ $recent->user_name }}</a></h5>
				                                <p style="font-size:12px;">{{\Carbon\Carbon::parse($recent->visitor_time)->diffForHumans()}}</p>
				                            </div>
				                        </div>
		                               @endforeach()
		                        </div>
