                          ...
                          <div class="panel-body">
		               		@foreach($datas as $data)
					                <div class="media blog-cmnt">
					                    <img  style="width:48px;height:48px;" alt="☴☲☷  ☳☯☱  ☶☵☰" src="{{ route('getThumbImg', $data->from_user_id ) }}" class="pull-left media-object">
					                    <div class="media-body">
					                        ...
					                        <div class="bl-status" style="margin-top:-18px;">{{ $data->content }}</div>
					                    </div>
					                </div>
					      @endforeach()
					     </div>
