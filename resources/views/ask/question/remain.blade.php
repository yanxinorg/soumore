			...
			<div class="aw-content-wrap clearfix">
				<div class="col-sm-12 col-md-9 aw-main-content">
					...
					<ul class="nav nav-tabs aw-nav-tabs active hidden-xs">
						<li class="active"><a href="{{ url('/question/remainCate') }}">待回答</a></li>
					...
					<div class="aw-mod aw-explore-list">
    						<div class="aw-mod aw-topic-category">
                                ...
                                <ul>
									@if(empty($cid))
										<li><a class="active" href="{{ url('/question/remainCate') }}">全部分类</a></li>
									@else
										<li><a href="{{ url('/question/remainCate') }}">全部分类</a></li>
									@endif
									...
									<div class="aw-item article" data-topic-id="3,">
										...
										<div class="aw-question-content">
											...
											<p>
												...
												<a href="{{ URL::action('Front\HomeController@index', ['uid'=>$data->user_id]) }}" class="aw-user-name">{{ $data->author }}</a> <span class="text-color-999">发布了提问 • {{ $data->comments }}个评论 • {{ $data->views }} 次浏览 • {{\Carbon\Carbon::parse($data->created_at)->diffForHumans()}}</span>
											</p>
										</div>
									</div>
									@endforeach()
                    			...
                    			<div class="mod-body">
                    				...
                    				<dl>
                        				<dt class="pull-left aw-border-radius-5">
                        					<a href="{{ URL::action('Front\TopicController@detail', ['id'=>$tag->id]) }}"><img  src="{{ $tag->thumb }}"></a>
                        				</dt>
                        				<dd class="pull-left">
                        					<p class="clearfix">
