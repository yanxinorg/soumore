			...
			<div class="row">
				<div class="aw-content-wrap clearfix">
					<div class="col-sm-12 col-md-9 aw-main-content">
						...
						<!-- end tab 切换 -->
						<form action="{{ url('/question/update') }}" method="post" enctype="multipart/form-data" onkeydown="if(event.keyCode==13)return false;">
                            {{ csrf_field() }}
					...
					<div class="col-sm-12 col-md-3 aw-side-bar hidden-xs">
						...
						<div class="aw-mod publish-help">
							...
							<div class="mod-body">
								<p><b>• 问题标题:</b> 请用准确的语言描述您发布的文章思想</p>
								<p><b>• 问题内容:</b> 详细补充您的文章内容, 并提供一些相关的素材以供参与者更多的了解您所要文章的主题思想</p>
