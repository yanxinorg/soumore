                ...
                <div class="aw-content-wrap clearfix">
                    <div class="col-sm-12 col-md-9 aw-main-content">
                        ...
                        <div class="aw-mod aw-user-detail-box">
                            <div class="mod-head">
                                <img style="width:100px;" src="{{ $userinfo['avator'] }}" onerror="this.src='{{ asset('ask/img/default_avator.jpg') }}'">
                                @if(Auth::id() == $uid)
                            ...
                            <div class="mod-footer">
                                <ul class="nav nav-tabs aw-nav-tabs">
                                    ...
                                    <li class="active"><a href="{{ URL::action('Front\HomeController@topicUser', ['uid'=>$uid]) }}">关注的人<span class="badge">{{  $countUsers }}</span></a></li>
                                            ...
                                            <div class="row">
                                                @foreach($topicUsers as $topicUser)
                                                    <div class="col-md-3" style="text-align: center;">
                                                        <a class="img aw-border-radius-5" href="{{ URL::action('Front\HomeController@index', ['uid'=>$topicUser->user_id]) }}">
                                                            <img style="width:60px;height: 60px;" src="{{ $topicUser->avator}}" onerror="this.src='{{ asset('ask/img/default_avator.jpg') }}'">
                                                        </a>
                                                        <p class="clearfix" >
                                                            <a class="text" href="{{ URL::action('Front\HomeController@index', ['uid'=>$topicUser->user_id]) }}">{{ $topicUser->name }}</a>
                                                        </p>
                                                    </div>
                                                @endforeach()
                                            </div>
                    ...
                    <div class="col-sm-12 col-md-3 aw-side-bar">
                        <div class="aw-mod people-following">
                            <div class="mod-body">
                                ...
                                <p>
                                @foreach($topicUsers as $topicUser)
                                    <a class="aw-user-name" data-id="3" href="{{ URL::action('Front\HomeController@index', ['uid'=>$topicUser->user_id]) }}"><img src="{{ $topicUser->avator }}-sm_thumb_middle" onerror="this.src='{{ asset('ask/img/default_avator.jpg') }}'"></a>
                                @endforeach()
                                </p>
                            </div>
                        </div>
