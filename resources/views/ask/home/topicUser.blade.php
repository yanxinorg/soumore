                        ...
                        <div class="aw-user-center-tab">
                            <div class="tab-content">
                                <div class="tab-pane " id="overview">
                                    ...
                                    <div class="aw-mod">
                                        <div class="mod-head">
                                            <h3><a class="pull-right aw-more-content" href="javascript:;" onclick="">更多 »</a>回复</h3>
                                        </div>
                                        <div class="mod-body">
                                    ...
                                    <div class="aw-mod">
                                        <div class="mod-head">
                                            <h3><a class="pull-right aw-more-content" href="javascript:;" onclick="">更多 »</a>动态</h3>
                                        </div>
                                        <div class="mod-body">
                                            <ul>
                                                <p class="padding10 text-center">没有内容</p>
                                                ...
                                                <div class="aw-mod aw-user-center-follow-mod">
                                                    <div class="mod-body">
                                                        <ul class="clearfix">
                                                            ...
                                                            <li>
                                                                <div class="mod-head">
                                                                    <a class="aw-user-img pull-left aw-border-radius-5" href="{{ URL::action('Front\HomeController@index', ['uid'=>$topicUser->user_id]) }}">
                                                                        <img style="width: 50px;" src="{{ $topicUser->avator}}-sm_thumb_small" >
                                                                    </a>
                                                                    <p><a href="{{ URL::action('Front\HomeController@index', ['uid'=>$topicUser->user_id]) }}">{{ $topicUser->name }}</a></p>
                                                                </div>
                                                                <div class="mod-body">
