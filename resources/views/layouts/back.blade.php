...
<head>
  ...
  <title>SouMore</title>
    <title>搜MORE管理后台</title>
     @section('css')
      <!--icheck-->
      <link href=" {{ asset('back/js/iCheck/skins/minimal/minimal.css') }}" rel="stylesheet">
      <link href="{{ asset('back/js/iCheck/skins/square/square.css') }}" rel="stylesheet">
      <link href="{{ asset('back/js/iCheck/skins/square/red.css') }}" rel="stylesheet">
      <link href="{{ asset('back/js/iCheck/skins/square/blue.css') }}" rel="stylesheet">
      <!--dashboard calendar-->
      <link href="{{ asset('back/css/clndr.css') }}" rel="stylesheet">
      <!--Morris Chart CSS -->
      <link rel="stylesheet" href="{{ asset('back/js/morris-chart/morris.css') }}">
      <!--common-->
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="{{ url('/admin') }}"><img src="{{ asset('back/images/logo.png') }}" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="{{ url('/admin') }}"><img src="{{ asset('back/images/logo_icon.png') }}" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="{{ asset('back/images/photos/user-avatar.png') }}" class="media-object">
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="{{ asset('back/images/photos/user1.png') }}" alt="" /></span>
                                        <span class="desc">
                                          <span class="name">{{ Auth::user()->name }} <span class="badge badge-success">new</span></span>
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ asset('back/images/photos/user2.png') }}" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ asset('back/images/photos/user3.png') }}" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ asset('back/images/photos/user4.png') }}" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="{{ asset('back/images/photos/user5.png') }}" alt="" /></span>
                                        <span class="desc">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset('back/images/photos/user-avatar.png') }}" alt="" />
                            {{ Auth::user()->name }}
...
<script src="{{ asset('back/js/jquery-1.10.2.min.js') }}"></script>
...
<!--easy pie chart-->
<script src="{{ asset('back/js/easypiechart/jquery.easypiechart.js') }}"></script>
<script src="{{ asset('back/js/easypiechart/easypiechart-init.js') }}"></script>
<!--Sparkline Chart-->
<script src="{{ asset('back/js/sparkline/jquery.sparkline.js') }}"></script>
<script src="{{ asset('back/js/sparkline/sparkline-init.js') }}"></script>
<!--icheck -->
<script src="{{ asset('back/js/iCheck/jquery.icheck.js') }}"></script>
<script src="{{ asset('back/js/icheck-init.js') }}"></script>
<!-- jQuery Flot Chart-->
<script src="{{ asset('back/js/flot-chart/jquery.flot.js') }}"></script>
