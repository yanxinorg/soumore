...
class PostController extends Controller
{
    ...
    public function index()
    {
    	...
    	->select('users.name as author','users.id as user_id', 'posts.id as post_id','posts.title as title', 'posts.status as status','posts.created_at as created_at','posts.deleted_at as deleted_at')
